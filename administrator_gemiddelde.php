...
//totaal aantal stappen worden door aantal dagen gedeeld om gemiddelde te berekenen
$totaal_team1 = round($totaal_team1 / 7); 
...
//totaal aantal stappen worden door aantal dagen gedeeld om gemiddelde te berekenen
$totaal_team2 = round($totaal_team2 / 7);
...
//totaal aantal stappen worden door aantal dagen gedeeld om gemiddelde te berekenen
$totaal_team3 = round($totaal_team3 / 7);
...
//totaal aantal stappen worden door aantal dagen gedeeld om gemiddelde te berekenen
$totaal_team4 = round($totaal_team4 / 7); 
...
//totaal aantal stappen worden door aantal dagen gedeeld om gemiddelde te berekenen
$totaal_team5 = round($totaal_team5 / 7);

array_push($totaal, $totaal_team5);

echo "<h4>Gemiddelde aantal stappen van alle teams</h4>";

echo "<br><table border='1'>";
echo "<tr><th></th><th>Gemiddelde</th></tr>";
$t = 1;
